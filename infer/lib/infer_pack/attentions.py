...
class FFN(nn.Module):
    def __init__(
        ...
        self.conv_1 = nn.Conv1d(in_channels, filter_channels, kernel_size, padding="same", padding_mode="reflect")
        self.conv_2 = nn.Conv1d(filter_channels, out_channels, kernel_size, padding="same", padding_mode="reflect")
        self.drop = nn.Dropout(p_dropout)
